...
- "lifted": пост сообщает СВЕРШИВШИЙСЯ факт снятия режима ("режим временного ограничения снят", "дал команду включить всех потребителей"). НЕ lifted, если про будущее ("как только ограничения будут сняты").
- "ignore": всё остальное — новости, телеэфиры, поздравления, реклама канала в МАКС, общая информация без конкретного окна и очереди, а также посты вида "введён режим, но точного графика пока нет".
