...
Правила:
- "outage": ТОЛЬКО веерное отключение по ГРАФИКУ ОЧЕРЕДИ (1-й или 2-й) в конкретный интервал времени. Обязательно должна быть явно указана очередь (1 или 2). Формулировки бывают разные и равнозначны: "будет ограничено по графику N очереди", "обесточены потребители по графику N очереди", "введён режим ... по N очереди", "отключение по N очереди" и т.п.
